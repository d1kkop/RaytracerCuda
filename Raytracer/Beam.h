...
namespace Beam
{
    ...
    public:
        ...
        virtual u32 clear(sptr<IRenderTarget>& target, u32 value) = 0;
        virtual u32 traceScene(const float* eye3, const float* orient3x3, sptr<IScene>& scene, sptr<IRenderTarget>& target) = 0;
    };
